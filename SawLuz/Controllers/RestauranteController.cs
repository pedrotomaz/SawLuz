...
namespace SawLuz.Controllers
{
    public class RestauranteController : Controller
    {
        ...
        //// GET: Restaurante/Pesquisa/5
        //public ActionResult Pesquisa(string nome)
        //{
        //    var listaPesquisa = db.Restaurantes.Where(x => x.Nome == nome);
        //    return View(listaPesquisa.ToList());
        //}
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,IdPrato")] Restaurante restaurante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,IdPrato")] Restaurante restaurante)
        {
            if (ModelState.IsValid)
            {
